    ...
    <>
      <div className="container flex mx-auto w-full flex-col">
        ...
        <div className="flex justify-center w-full mx-auto ">
          <button className="flex mx-auto items-center text-xl justify-center md:py-3 py-2 md:px-12 px-8 focus:outline-none  rounded text-white  mt-4 bg-[#a95414]  " onClick={()=>{
